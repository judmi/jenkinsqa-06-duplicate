...
public class CreateFreestyleProject4Test extends BaseTest {
    ...
    public void testNameTheFirstJob() {
        ...
        WebElement createdNameJob = getDriver().findElement(By.xpath(
                "//td/a[@class='jenkins-table__link model-link inside']/span['test']"));
