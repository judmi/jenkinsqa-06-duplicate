...
public class MultiConfigurationProjectPage extends BasePage {
    ...
    public String getJobBuildStatus(String jobName) {
        WebElement buildStatus = getWait20().until(ExpectedConditions
                .visibilityOf(getDriver().findElement(By.xpath("//div[@id='matrix']//span[@class='build-status-icon__outer']/child::*"))));
